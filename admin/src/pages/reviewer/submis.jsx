...
//          <div className="max-w-7xl mx-auto">
//             <h1 className="text-3xl font-bold mb-2">Assigned Submissions</h1>
...
//                      <Search className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
//                      <input
//                         className="w-full pl-10 p-2 rounded-lg border bg-gray-50 dark:bg-gray-700 dark:border-gray-600"
//                         placeholder="Search..."
//                         value={searchTerm}
//                         onChange={(e) => setSearchTerm(e.target.value)}
//                      />
...
//                      <tr>
//                         <th className="p-4 text-left">Paper ID</th>
...
//                         >
//                            <td className="p-4 font-medium">{s.paperId}</td>
//                            <td className="p-4">{s.title}</td>
//                            <td className="p-4">{s.author?.name}</td>
//                            <td className="p-4">
...
//                <div className="bg-white dark:bg-gray-800 rounded-xl w-full max-w-xl shadow-lg">
...
//                      <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded flex gap-2">
